...
#    sitk_img.SetMetaData("0020|000d", str(filename))
    ...
    sitk.WriteImage(sitk_img, fpath.replace(".wmv",".dcm"))
    print("Converted "+fpath)
    return

##write arparse
parser = argparse.ArgumentParser(description='Converts wmv to dcm. Either call it on a single file or a folder containing wmv files.')
...
#sample call
#python wmv2nii.py sample/Image02.wmv 
